<cp-thumbnail>
    ...
    <div class="uk-position-relative">
        ...
        <canvas ref="canvas" width="{ this.width || ''}" height="{ this.height || ''}" style="margin:0 auto;background-size:contain;background-position:50% 50%;background-repeat:no-repeat;visibility:hidden;"></canvas>
    </div>
