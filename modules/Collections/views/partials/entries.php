        ...
        <div class="uk-clearfix uk-margin-top" show="{ !loading && (entries.length || filter) }">
            ...
            <div class="uk-float-left uk-form-select uk-margin-small-left" if="{ !loading && languages.length }">
                ...
                <select onchange="{changelanguage}">
                    ...
                    <option each="{language,idx in languages}" value="{language.code}"
                        selected="{lang === language.code}">{language.label}</option>
                </select>
            </div>
            ...
            <div class="uk-float-left uk-width-1-2 uk-margin-small-left">
                <div class="uk-form-icon uk-form uk-width-1-1 uk-text-muted">
                    ...
                    <input
                        class="uk-width-1-1 uk-form-large uk-form-blank {filter && filter.match(/\{(.*)\}/) && 'uk-text-monospace'}"
                        type="text" ref="txtfilter" placeholder="@lang('Filter items...')" onchange="{ updatefilter }">
                            ...
                            <span data-uk-dropdown="mode:'click', pos:'bottom-right'">
                                ...
                                <div class="uk-dropdown uk-dropdown-flip">
                                    <ul class="uk-nav uk-nav-dropdown">
                                        ...
                                        @if($app->module('collections')->hasaccess($collection['name'], 'entries_edit'))
                                        <li><a
                                                href="@route('/collections/entry/'.$collection['name'])/{ entry._id }">@lang('Edit')</a>
                                        </li>
                                        @else
                                        <li><a
                                                href="@route('/collections/entry/'.$collection['name'])/{ entry._id }">@lang('View')</a>
                                        </li>
                                        @endif

                                        @if($app->module('collections')->hasaccess($collection['name'],
                                        'entries_delete'))
                                        ...
                                        <li><a class="uk-dropdown-close"
                                                onclick="{ parent.duplicateEntry }">@lang('Duplicate')</a></li>
                                        @endif
                                    </ul>
                                </div>
                            </span>
                            ...
                            <div class="uk-margin-small-top { pages > 5 ? 'uk-scrollable-box':'' }">
                                <ul class="uk-nav uk-nav-dropdown">
                                    <li class="uk-text-small" each="{k,v in new Array(pages)}"><a
                                            ...
                                            onclick="{ parent.loadpage.bind(parent, v+1) }">@lang('Page') {v + 1}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
